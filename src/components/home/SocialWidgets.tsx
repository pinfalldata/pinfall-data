  ...
  'Snapchat': {
    ...
    svg: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 512 512">
        <path d="M256.1 2C140.3 2 62.5 96 62.5 206.8c0 34.3 5.3 65 13.2 90.2-2.4 1.3-5 2.4-7.8 3.4-12.3 4.6-29.7 8.5-38 10.4-8.1 1.8-15.6 5.8-15.6 14.2 0 8.8 11.2 16.2 26 20.6 5 1.5 10.6 2.8 16.2 4.2 6.2 1.5 12.4 3 16.7 5.2 7.2 3.7 10.3 9.4 14.5 18.7 1.5 3.3 3.1 6.9 5.4 10.7 8 12.9 22.2 19.2 49.1 19.2 11.5 0 24.5-1.5 39.3-4.5 1 12.3 5 40.3 56.7 71.5 38.2 23.1 74.9 34.9 109 35.1h2.7c34.1-.2 70.8-12 109-35.1 51.7-31.3 55.8-59.3 56.7-71.5 14.8 3 27.7 4.5 39.3 4.5 26.8 0 41.1-6.3 49.1-19.2 2.3-3.8 3.9-7.4 5.4-10.7 4.2-9.3 7.3-15 14.5-18.7 4.3-2.2 10.5-3.7 16.7-5.2 5.6-1.4 11.2-2.7 16.2-4.2 14.8-4.4 26-11.8 26-20.6 0-8.4-7.5-12.4-15.6-14.2-8.3-1.9-25.7-5.8-38-10.4-2.8-1-5.4-2.1-7.8-3.4 7.9-25.2 13.2-55.9 13.2-90.2C449.5 96 371.7 2 256.1 2z"/>
      </svg>
    ),
  },
}
