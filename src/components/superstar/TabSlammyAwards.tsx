  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center gap-4 mb-6">
        <div className="relative w-16 h-16 sm:w-20 sm:h-20 shrink-0"><Image src={TROPHY_IMG} alt="Slammy Award" fill className="object-contain drop-shadow-[0_0_15px_rgba(234,179,8,0.3)]" sizes="80px" /></div>
      ...
      <div className="space-y-3">
        {items.map((item: any) => (
          <div key={item.id} className="flex items-center gap-4 p-4 rounded-2xl border border-border-subtle/20 bg-bg-secondary/15 hover:border-neon-blue/20 transition-all">
            <div className="relative w-12 h-12 shrink-0"><Image src={TROPHY_IMG} alt="" fill className="object-contain drop-shadow-[0_0_6px_rgba(234,179,8,0.2)]" sizes="48px" /></div>
