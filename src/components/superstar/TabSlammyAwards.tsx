  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div><h2 className="font-display text-xl sm:text-2xl font-bold text-text-white">Slammy Awards</h2><p className="text-sm text-text-secondary">{items.length} award{items.length !== 1 ? 's' : ''} won</p></div>
      </div>
