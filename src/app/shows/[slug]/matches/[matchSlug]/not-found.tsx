...
export default function MatchNotFound() {
  return (
    <div className="max-w-[1440px] mx-auto px-4 sm:px-6 py-20 text-center">
      <h1 className="font-display text-4xl font-bold text-text-white mb-4">Match Not Found</h1>
      <p className="text-text-secondary mb-8">This match doesn&apos;t exist in our database yet.</p>
