...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'WWE Interviewers — Complete Directory | Pinfall Data', description: 'Every WWE interviewer with interview segment stats.', images: ['https://xusywypjmogzbizrwruv.supabase.co/storage/v1/object/public/Images/Page%20superstars/interview.jpg'], type: 'website' },
