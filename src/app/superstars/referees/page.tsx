...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'WWE Referees — Complete Directory | Pinfall Data', description: 'Every WWE referee with matches-refereed stats and special guest referees.', images: ['https://xusywypjmogzbizrwruv.supabase.co/storage/v1/object/public/Images/Page%20superstars/robinson.jpg'], type: 'website' },
