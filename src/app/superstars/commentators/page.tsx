...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'WWE Commentators — Complete Directory | Pinfall Data', description: 'Every WWE commentator with shows-commented stats.', images: ['https://xusywypjmogzbizrwruv.supabase.co/storage/v1/object/public/Images/Page%20superstars/Michael-Cole-Wade-Barrett-e1691185791664.webp'], type: 'website' },
...
const config = {
  roleKey: 'commentator',
  title: 'Commentators',
  heroImage: 'https://xusywypjmogzbizrwruv.supabase.co/storage/v1/object/public/Images/Page%20superstars/Michael-Cole-Wade-Barrett-e1691185791664.webp',
  ...
  extraInfoKey: null,
  seoDescription: 'The complete database of WWE commentators. Every play-by-play and color commentator who called the action, with their number of shows commented. Also discover guest commentators — superstars who stepped behind the broadcast table for special occasions.',
}
