...
export default function StipulationDetailPage() {
  ...
  return (
    <div className="relative">
      {/* ===== HERO ===== */}
      <section className="relative w-full h-[220px] sm:h-[300px] lg:h-[400px] overflow-hidden">
        {matchType?.image_url ? (
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-end pb-6 sm:pb-8 lg:pb-10 px-4">
          ...
          <h1 className="font-display text-2xl sm:text-3xl lg:text-5xl font-bold text-text-white text-center tracking-tight mb-2">
