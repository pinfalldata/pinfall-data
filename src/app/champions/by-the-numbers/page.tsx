    ...
    <div className="relative min-h-screen">
      ...
      <section className="max-w-[1440px] mx-auto px-4 sm:px-6 py-12 lg:py-20">
        <div className="glass rounded-2xl p-12 border border-border-subtle text-center">
          ...
          <Link href="/champions" className="inline-flex items-center gap-2 mt-6 px-5 py-2.5 rounded-xl bg-yellow-500/15 border border-yellow-500/30 text-yellow-400 text-sm font-medium hover:bg-yellow-500/25 transition-all">
