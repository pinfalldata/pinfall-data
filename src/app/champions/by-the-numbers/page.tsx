...
export const metadata: Metadata = {
  title: 'By The Numbers — WWE Champions | Pinfall Data',
  description: 'Championship statistics, records, and data breakdowns across all WWE titles.',
}
  ...
  return (
    <div className="relative min-h-screen">
      <section className="relative w-full h-[220px] sm:h-[300px] lg:h-[380px] xl:h-[420px] overflow-hidden">
        <Image src="https://xusywypjmogzbizrwruv.supabase.co/storage/v1/object/public/Images/Page%20champions/WWE-New-titles-1_2026-03-11_13_28_40.220684.jpg.png"
          alt="By The Numbers" fill priority sizes="100vw" quality={100} unoptimized className="object-cover object-center" />
      ...
      <section className="max-w-[1440px] mx-auto px-4 sm:px-6 py-12 lg:py-20">
        <div className="glass rounded-2xl p-12 border border-border-subtle text-center">
          ...
          <p className="text-text-secondary text-sm">Cross-title statistics, record holders, and deep dives coming soon.</p>
