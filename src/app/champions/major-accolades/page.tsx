  ...
  return (
    <div className="relative min-h-screen">
      <section className="relative w-full h-[220px] sm:h-[300px] lg:h-[380px] xl:h-[420px] overflow-hidden">
        <Image src="https://xusywypjmogzbizrwruv.supabase.co/storage/v1/object/public/Images/Page%20champions/IMG_20221213_102348-01.webp" alt={t('champions.majorAccolades.title')} fill priority sizes="100vw" quality={100} className="object-cover object-center" />
